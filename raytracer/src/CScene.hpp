...
class CCamera {
public:
    int width = 500; ///< Horizontal resolution in pixels.
    int height = 400; ///< Vertical resolution in pixels.
    float fov = 50.0f; ///< Field-of-view (<0,180) range)
    glm::vec3 eyep = {0,0,10}; ///< Camera position.
